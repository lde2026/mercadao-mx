          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 sticky top-20 shadow-sm">
            ...
            <div className="flex items-center gap-3 mb-6 pb-5 border-b border-slate-200">
              <div className="relative w-12 h-12 rounded-full overflow-hidden bg-slate-100 flex-shrink-0">
                {CURRENT_USER.avatar ? (
                  <Image src={CURRENT_USER.avatar} alt={CURRENT_USER.name} fill sizes="48px" className="object-cover" />
                ) : (
              ...
              <div className="min-w-0">
                <p className="text-slate-900 font-semibold text-sm truncate">{CURRENT_USER.name}</p>
                <p className="text-slate-400 text-xs truncate">{CURRENT_USER.email}</p>
              </div>
            </div>
