...
Host unico: `capta.lojadoecommerce.com.br` serve painel, API e widget. O
Cloudflare fica na frente e segura o `widget.js`, que e baixado por todo
visitante de toda loja cliente.
...
4. Variaveis do servico (Settings, Variables):
   ...
   | `PORTA` | `3000` |
   | `URL_PUBLICA` | `https://capta.lojadoecommerce.com.br` |
...
1. No Railway, Settings, **Custom Domain**: `capta.lojadoecommerce.com.br`.
   Ele mostra um alvo de CNAME.
2. No Cloudflare, DNS de `lojadoecommerce.com.br`: registro **CNAME**
   `capta` apontando para o alvo do Railway, com **proxy ligado** (nuvem
   laranja).
...
Com o dominio no ar, cadastre o webhook em `https://capta.lojadoecommerce.com.br/webhook/asaas`
...
```
curl https://capta.lojadoecommerce.com.br/saude
curl -I https://capta.lojadoecommerce.com.br/widget.js?k=x | grep -i "cache-control\|cf-cache-status"
```
