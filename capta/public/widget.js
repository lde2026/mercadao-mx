...
(function () {
  ...
  try {
    ...
    var ESTILO = [
      ...
      '.s{width:100%;padding:13px;border:0;border-radius:10px;background:var(--cor,#111);color:#fff;font-size:15px;font-weight:600;cursor:pointer}',
      ...
      'border:2px dashed var(--cor,#111);border-radius:12px;word-break:break-all}',
      ...
      '.ch{background:var(--cor,#111);color:#fff;padding:13px 16px;display:flex;align-items:center;gap:10px}',
      ...
      '.bb.eu{align-self:flex-end;background:var(--cor,#111);color:#fff;border-bottom-right-radius:4px;font-weight:600}',
      ...
      '.ps button{border:1.5px solid var(--cor,#111);background:#fff;color:var(--cor,#111);border-radius:999px;padding:9px 14px;font-size:14px;font-weight:600;cursor:pointer}',
      '.ps button:hover{background:var(--cor,#111);color:#fff}',
      '.ps button.leve{border-color:#dcdcdc;color:#666}',
      '.cp{display:flex;gap:8px}.cp input{border-radius:999px;padding:11px 14px}',
      '.cp button{border:0;border-radius:999px;background:var(--cor,#111);color:#fff;font-weight:700;padding:0 18px;cursor:pointer;font-size:14px}',
